...
def gridworld_5_cases_30_percent_returns(current_position: Tuple[int, int], actions: List[str]) -> Dict[str, Any]:
    """
    ...
    # if-statement 3
    if current_position == (1, 1) and get_next_action(actions) == "east":
    ...
    # if-statement 5
    if current_position == (1, 1) and get_next_action(actions) == "north":
