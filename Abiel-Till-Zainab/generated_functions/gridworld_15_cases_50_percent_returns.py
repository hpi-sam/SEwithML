...
def gridworld_15_cases_50_percent_returns(current_position: Tuple[int, int], actions: List[str]) -> Dict[str, Any]:
    """
    ...
    # if-statement 1
    if current_position == (6, 4) and get_next_action(actions) == "west":
        current_position = move(current_position, "west")

    # if-statement 2
    if current_position == (6, 3) and get_next_action(actions) == "south":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (6, 3)}

    # if-statement 3
    if current_position == (4, 1) and get_next_action(actions) == "north":
    ...
    # if-statement 7
    if current_position == (6, 2) and get_next_action(actions) == "west":
        current_position = move(current_position, "west")
    ...
    # if-statement 9
    if current_position == (1, 3) and get_next_action(actions) == "east":
        current_position = move(current_position, "east")
    ...
    # if-statement 11
    if current_position == (4, 6) and get_next_action(actions) == "west":
        current_position = move(current_position, "west")

    # if-statement 12
    if current_position == (4, 5) and get_next_action(actions) == "south":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (4, 5)}

    # if-statement 13
    if current_position == (6, 2) and get_next_action(actions) == "east":
        current_position = move(current_position, "east")

    # if-statement 14
    if current_position == (6, 3) and get_next_action(actions) == "east":
        current_position = move(current_position, "east")

    # if-statement 15
    if current_position == (6, 4) and get_next_action(actions) == "south":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (6, 4)}
