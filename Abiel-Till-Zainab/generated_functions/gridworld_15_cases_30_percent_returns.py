...
def gridworld_15_cases_30_percent_returns(current_position: Tuple[int, int], actions: List[str]) -> Dict[str, Any]:
    """
    ...
    # if-statement 1
    if current_position == (6, 6) and get_next_action(actions) == "west":
    ...
    # if-statement 3
    if current_position == (6, 6) and get_next_action(actions) == "north":
    ...
    # if-statement 5
    if current_position == (6, 3) and get_next_action(actions) == "west":
        current_position = move(current_position, "west")
    ...
    # if-statement 9
    if current_position == (1, 6) and get_next_action(actions) == "east":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (1, 6)}

    # if-statement 10
    if current_position == (4, 4) and get_next_action(actions) == "west":
        current_position = move(current_position, "west")

    # if-statement 11
    if current_position == (4, 3) and get_next_action(actions) == "east":
        current_position = move(current_position, "east")
    ...
    # if-statement 14
    if current_position == (5, 3) and get_next_action(actions) == "north":
        current_position = move(current_position, "north")

    # if-statement 15
    if current_position == (4, 3) and get_next_action(actions) == "west":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (4, 3)}
