...
def gridworld_10_cases_70_percent_returns(current_position: Tuple[int, int], actions: List[str]) -> Dict[str, Any]:
    """
    ...
    # if-statement 5
    if current_position == (6, 5) and get_next_action(actions) == "north":
        # Action bumps into a wall
        return {"valid_action_sequence": False, "final_position": (6, 5)}
    ...
    # if-statement 10
    if current_position == (6, 2) and get_next_action(actions) == "north":
        # Action bumps into a wall
